                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>SKU</label>
                                    <input type="text" name="sku" placeholder="VD: ST628W"
                                           value="${product.sku}" ${transactionExist != null ? 'readonly' : ''}>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Product Name</label>
                                        <input type="text" name="productName" placeholder="VD: ZenBook 14 UX3405CA"
                                               value="${product.name}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="model"
                                            ...
                                            <c:forEach var="i" items="${modelList}">
                                                <option value="${i.id}"
                                                        data-brand="${i.brand.getId()}" ${product != null && product.model.getId() == i.id ? 'selected' : ''}>${i.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Status</label>
                                        <select class="select" name="isActive">
                                            <option value="1" ${product != null && product.isActive == true ? 'selected' : ''}>
                                                Active
                                            </option>
                                            <option value="0" ${product != null && product.isActive == false ? 'selected' : ''}>
                                                Deactive
                                            </option>
                                        </select>
                                    </div>
...
=======
            $(function () {
                ...
                const $modelSelect = $("#modelSelect");
                const modelSelect = $modelSelect[0];
                const selectedModelId = "${product.model.id}";
>>>>>>> Stashed changes
