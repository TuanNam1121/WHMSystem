...
<head>
    ...
    <title>Create Purchase Request - WHM System</title>
                    ...
                    <form action="createPurchaseRequest" method="post">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="supplierId" required>
                                        <option value="" disabled ${empty param.supplierId
                                                ? 'selected' : '' }>Select a supplier
                                        </option>
                        ...
                        <div class="row align-items-stretch">
                            <div class="col-lg-12 col-md-12 d-flex mb-4">
                                <div class="card bg-light w-100 d-flex flex-column mb-0">
                                    <div class="card-body p-3 d-flex flex-column">
                                        <h5 class="mb-3" style="font-weight: 600;">Selected Items
                                        </h5>
                                        <div class="table-responsive flex-grow-1"
                                            ...
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Category</th>
                                                    <th>Price</th>
                                                    <th style="width: 150px;">Required Quantity
                                                    </th>
                                                    <th>Action</th>
                                                </tr>
                                                </thead>
