        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <c:if test="${sessionScope.userPermissions.contains('VIEW_REPORT')}">
                    <li class="submenu">
                        <a href="javascript:void(0);"><img src="assets/img/icons/time.svg"
                                ...
                                class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/inventorySummaryReport">Inventory Report</a>
                            </li>
                            ...
                            <li><a href="${pageContext.request.contextPath}/ImportExportByDayReport">Daily Transaction
                                Report</a></li>
                        </ul>
                    </li>
                </c:if>
                ...
                <c:if test="${sessionScope.userPermissions.contains('VIEW_INVENTORY_AUDIT')}">
                    <li>
                        <a href="InventoryAuditList"><i data-feather="layers"></i><span> Inventory Audit List</span>
                        </a>
                    </li>
                </c:if>
                ...
                <c:if test="${sessionScope.userPermissions.contains('VIEW_INVENTORY_TRANSACTION')}">
                    <li>
                        <a href="InventoryTransaction"><i
                                data-feather="repeat"></i><span> Inventory Transaction List</span> </a>
                    </li>
                </c:if>
