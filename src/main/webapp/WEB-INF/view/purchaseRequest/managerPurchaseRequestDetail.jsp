        ...
        <%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <head>
                    ...
                    <title>Manager - Purchase Request Detail - WHM System</title>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex align-items-center mt-1">
                                                        <div>
                                                            ...
                                                            <small class="text-muted" id="detail-supplier-id">ID:
                                                                ${purchaseRequest.supplierId}</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${purchaseItems}" var="item" varStatus="status">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><strong>${item.requiredQty}</strong>
                                                            </td>
                                                            <td class="text-center">
                                                                <c:choose>
                                                                    <c:when test="${product.totalQuantity == 0}">
                                                                        <span
                                                                            class="badges bg-lightred">${product.totalQuantity}
                                                                            left</span>
                                                                    </c:when>
                                                                    <c:when test="${product.totalQuantity <= 10}">
                                                                        <span
                                                                            class="badges bg-lightyellow">${product.totalQuantity}
                                                                            left</span>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <span
                                                                            class="badges bg-lightgreen">${product.totalQuantity}
                                                                            left</span>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </td>
                                                            <td style="text-align: right;">
                                                                <fmt:formatNumber
                                                                    value="${item.price * item.requiredQty}"
                                                                    pattern="#,###" var="formattedRowTotal" />
                                                                <strong>${fn:replace(formattedRowTotal, ',',
                                                                    '.')}đ</strong>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td colspan="6" style="text-align: right; font-weight: 600;">
                                                            Grand Total:</td>
                                                        <td
                                                            style="text-align: right; font-weight: 700; color: #28C76F; font-size: 16px;">
