...
<head>
    ...
    <meta name="description" content="Detailed daily import and export inventory report with charts and statistics">
    ...
    <style>
        ...
        .day-summary-icon.icon-green  { background: #ddf8ec; color: #28c76f; }
        .day-summary-icon.icon-red    { background: #ffe5e5; color: #ea5455; }
        .day-summary-icon.icon-blue   { background: #ddf0ff; color: #00cfe8; }
        .day-summary-icon.icon-orange { background: #fff4cc; color: #ff9f43; }
        ...
        <div class="content">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h4>Báo Cáo Chi Tiết Xuất Nhập Vật Tư Theo Ngày</h4>
                    <h6>Xem chi tiết nhập / xuất vật tư theo từng ngày</h6>
                </div>
                ...
                <div class="col-lg-5 col-sm-12 mb-3">
                    <div class="chart-card">
                        <div class="chart-card-title">
                            ...
                            Phân bổ số lượng giao dịch trong ngày
                        </div>
                        ...
                        <div class="d-flex justify-content-center gap-3 mt-3" style="font-size:12px;">
                            <span><span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#28c76f;margin-right:4px;"></span>Nhập kho</span>
                            <span><span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#ea5455;margin-right:4px;"></span>Xuất kho</span>
                            <span><span style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#ff9f43;margin-right:4px;"></span>Điều chỉnh</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7 col-sm-12 mb-3">
                    <div class="chart-card">
                        <div class="chart-card-title">
                            ...
                            Top 5 Vật Tư Nhập / Xuất Nhiều Nhất Trong Ngày
                        </div>
                        ...
                        <ul class="nav nav-tabs mb-3" id="rankingTab" role="tablist" style="font-size:13px;">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="tab-import-btn" data-bs-toggle="tab"
                                    ...
                                    <i class="fas fa-arrow-down me-1"></i> Top Nhập Nhiều Nhất
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="tab-export-btn" data-bs-toggle="tab"
                                    ...
                                    <i class="fas fa-arrow-up me-1"></i> Top Xuất Nhiều Nhất
                                </button>
                            </li>
                        </ul>
                                            ...
                                            <c:choose>
                                                <c:when test="${not empty top5Import}">
                                                    <c:forEach items="${top5Import}" var="item" varStatus="v">
                                                        <tr>
                                                            <td>
                                                                <span class="rank-badge rank-${v.index + 1}">${v.index + 1}</span>
                                                            </td>
                                                            <td>${item.sku}</td>
                                                            <td class="td-name">${item.productName}</td>
                                                            <td>${item.unit}</td>
                                                            <td><strong style="color:#28a745;">
                                                                <fmt:formatNumber value="${item.importQty}" pattern="#,##0"/>
                                                            </strong></td>
                                                        </tr>
                                                    </c:forEach>
                                                </c:when>
                                                <c:otherwise>
                                                    <tr>
                                                        <td colspan="5" class="no-data-placeholder">
                                                            ...
                                                            Không có dữ liệu nhập kho trong ngày này
                                                        </td>
                                                    </tr>
                                                </c:otherwise>
                                            </c:choose>
                                            ...
                                            <c:choose>
                                                    ...
                                                    <c:forEach items="${top5Export}" var="item" varStatus="v">
                                                        <tr>
                                                            ...
                                                            <td><strong style="color:#ea5455;">
                                                                <fmt:formatNumber value="${item.exportQty}" pattern="#,##0"/>
                                                            </strong></td>
                                                        </tr>
                                                    </c:forEach>
                                                </c:when>
                                                <c:otherwise>
                                                    <tr>
                                                        <td colspan="5" class="no-data-placeholder">
                                                            <i class="fas fa-inbox"></i>
                                                            Không có dữ liệu xuất kho trong ngày này
                                                        </td>
                                                    </tr>
                                                </c:otherwise>
                                            </c:choose>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/ImportExportByDayReport" method="get" id="filter-form">
                                ...
                                <div class="col-lg-2 col-sm-6 col-12">
                                    <div class="form-group mb-0">
                                        <label for="input-date">
                                            <i class="fas fa-calendar-day me-1" style="color:#ff9f43;"></i> Ngày
                                        </label>
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group mb-0">
                                        <label for="input-keyword">
                                            <i class="fas fa-search me-1" style="color:#ff9f43;"></i> Tìm kiếm
                                        </label>
                                        <input type="text" id="input-keyword" name="keyword"
                                               value="${keyword}"
                                               placeholder="Tên vật tư hoặc SKU...">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-sm-6 col-12">
                                    <div class="form-group mb-0">
                                        <label for="input-sortby">
                                            <i class="fas fa-sort-amount-down me-1" style="color:#ff9f43;"></i> Sắp xếp theo
                                        </label>
                                        <select id="input-sortby" name="sortBy" class="select">
                                            <option value=""          ${empty param.sortBy ? 'selected' : ''}>-- Mặc định --</option>
                                            <option value="sku"       ${'sku'       == sortBy ? 'selected' : ''}>SKU</option>
                                            <option value="name"      ${'name'      == sortBy ? 'selected' : ''}>Tên vật tư</option>
                                            <option value="importQty" ${'importQty' == sortBy ? 'selected' : ''}>SL Nhập</option>
                                            <option value="exportQty" ${'exportQty' == sortBy ? 'selected' : ''}>SL Xuất</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-sm-6 col-12">
                                    <div class="form-group mb-0">
                                        <label for="input-sortdir">
                                            <i class="fas fa-exchange-alt me-1" style="color:#ff9f43;"></i> Chiều sắp xếp
                                        </label>
                                        <select id="input-sortdir" name="sortDir" class="select">
                                            <option value="asc"  ${'asc'  == sortDir || empty sortDir ? 'selected' : ''}>Tăng dần</option>
                                            <option value="desc" ${'desc' == sortDir ? 'selected' : ''}>Giảm dần</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive" id="import-export-day-table" tabindex="-1">
                            <table class="table report-summary-table">
                                        ...
                                        <c:when test="${not empty reportList}">
                                            <c:forEach items="${reportList}" var="item" varStatus="v">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span style="font-family: monospace; font-size:12px; background:#f3f4f6; padding:2px 6px; border-radius:4px;">
                                                            ${item.sku}
                                                        </span>
                                                    </td>
                                                    <td class="td-name">${item.productName}</td>
                                                    <td>${item.unit}</td>
                                                    <td>
                                                        <fmt:formatDate value="${item.transactionDate}" pattern="dd/MM/yyyy"/>
                                                    </td>
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${item.importQty > 0}">
                                            ...
                                            <tr>
                                                <td colspan="7">
                                                    <div class="no-data-placeholder">
                                                        ...
                                                        <small>Hãy chọn ngày hoặc thay đổi bộ lọc để xem dữ liệu</small>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:otherwise>
                                ...
                                <c:if test="${not empty reportList}">
                                    <tfoot>
                                        <tr style="background-color:#f8f9fa; font-weight:700; font-size:13px;">
                                            <td colspan="5" style="text-align:right; padding-right:15px;">
                                                <i class="fas fa-calculator me-1" style="color:#ff9f43;"></i> Tổng cộng:
                                            </td>
                                            <td style="color:#28a745;">
                                                +<fmt:formatNumber value="${totalImportQty != null ? totalImportQty : 0}" pattern="#,##0"/>
                                            </td>
                                            <td style="color:#ea5455;">
                                                -<fmt:formatNumber value="${totalExportQty != null ? totalExportQty : 0}" pattern="#,##0"/>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </c:if>
...
<script>
    function initPieChart() {
        if (window.__chartJsFailed) return; // CDN failed, already handled
...
<!-- Focus table on submit -->
<c:if test="${focusTable}">
    <script>
        window.addEventListener("load", function () {
            var table = document.getElementById("import-export-day-table");
            if (table) {
