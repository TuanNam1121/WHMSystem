...
<html lang="en">
    <head>
        ...
        <title>Update Customer - WHM System</title>
                                ...
                                <div class="row" style="display: block">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="customerName" value="${customer.name}"  minlength="1" maxlength="100">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Customer Phone</label>
                                            <input required type="text" name="customerPhone" value="${customer.phone}"  minlength="10" maxlength="10">
                                        </div>
                                    </div>
