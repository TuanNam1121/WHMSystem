...
<html lang="en">
    <head>
        ...
        <title>Create Order - WHM System</title>
                                                        ...
                                                        <tr class="product-item">
                                                            ...
                                                            <td>
                                                                <a class="btn btn-sm btn-outline-primary add-product-btn"
                                                                   href="OrderAddItem?id=${p.productId}&customerId=${customer.id}">
                                    ...
                                    <div class="table-responsive flex-grow-1"
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody id="selected-product-list">
                                                ...
                                                <c:forEach items="${sessionScope.selectedProducts}" var="p">
                                                    <tr>
                                                        <input type="hidden" value="${p.productId}" name="productId">
                                                        <td>${p.name}</td>
                                                        <td>${p.totalQuantity}</td>
                                                        <td><input required type="number" name="quantity_${p.productId}" min="1" max="${p.totalQuantity}"></td>
                                                        <td><input required type="number" name="price_${p.productId}" min="1" ></td>
                                                        <td>
                                                            <a class="btn btn-sm btn-outline-primary add-product-btn"
                                                               href="OrderRemoveItem?id=${p.productId}&customerId=${customer.id}">
