...
<head>
    ...
    <meta name="description" content="POS - Update Supplier">
        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    ...
                    <h6>Update existing supplier information</h6>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group text-end mt-4">
                                    ...
                                    <button type="submit" class="btn btn-submit">Update Supplier</button>
                                </div>
                            </div>
                        </div>
                    </form>
