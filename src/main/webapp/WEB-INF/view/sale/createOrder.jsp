                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="customerName" maxlength="50" value="${customer.name}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>Customer Phone</label>
                                            <input required type="text" name="customerPhone" minlength="10" maxlength="10" value="${customer.phone}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
