                                                ...
                                                <div class="col-lg-3 col-sm-6 col-12">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <input type="text" id="input-keyword" name="keyword"
                                                            value="${param.keyword}" placeholder="Tên vật tư hoặc SKU..."
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label for="input-sortby">
                                                            <i class="fas fa-sort-amount-down me-1"
                                                                style="color:#ff9f43;"></i> Sắp xếp theo
                                                        </label>
                                                        <select id="input-sortby" name="sortBy" class="select">
                                                            ...
                                                            <option value="name" ${'name'==param.sortBy ? 'selected' : '' }>
                                                                Tên vật tư</option>
                                                            <option value="importQty" ${'importQty'==param.sortBy ? 'selected'
                                                                : '' }>SL Nhập</option>
                                                            <option value="exportQty" ${'exportQty'==param.sortBy ? 'selected'
                                                                : '' }>SL Xuất</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label for="input-sortdir">
                                                            <i class="fas fa-exchange-alt me-1"
                                                                style="color:#ff9f43;"></i> Chiều sắp xếp
                                                        </label>
                                                        <select id="input-sortdir" name="sortDir" class="select">
                                                            <option value="asc" ${'asc'==param.sortDir || empty param.sortDir
                                                                ? 'selected' : '' }>Tăng dần</option>
                                                            <option value="desc" ${'desc'==param.sortDir ? 'selected' : '' }>
                                                                Giảm dần</option>
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-lg-5 col-sm-12 mb-3">
                                    <div class="chart-card">
                                        ...
                                        <div class="d-flex justify-content-center gap-3 mt-3" style="font-size:12px;">
                                            <span><span
                                                    style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#28c76f;margin-right:4px;"></span>Nhập
                                                kho</span>
                                            <span><span
                                                    style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#ea5455;margin-right:4px;"></span>Xuất
                                                kho</span>
                                            <span><span
                                                    style="display:inline-block;width:12px;height:12px;border-radius:50%;background:#ff9f43;margin-right:4px;"></span>Điều
                                                chỉnh</span>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <c:when test="${not empty reportList}">
                                                            <c:forEach items="${reportList}" var="item" varStatus="v">
                                                                <tr>
                                                                    ...
                                                                    <td>${item.unit}</td>
                                                                    <td>
                                                                        <fmt:formatDate value="${item.transactionDate}"
                                                                            pattern="dd/MM/yyyy" />
                                                                    </td>
                                                                    <td>
                                                                        <c:choose>
                                                        ...
                                                        <tr
                                                            ...
                                                            <td colspan="5"
                                                                ...
                                                                <i class="fas fa-calculator me-1"
                                                                    style="color:#ff9f43;"></i> Tổng cộng:
                                                            </td>
