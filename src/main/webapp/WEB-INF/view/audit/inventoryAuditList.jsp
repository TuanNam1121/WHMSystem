        ...
        <div class="content">
            <div class="page-header">
                ...
                <c:if test="${sessionScope.roleName == 'MANAGER'}">
                    <div class="page-btn">
                        <a href="AddInventoryAudit" class="btn btn-added"><img
                                src="assets/img/icons/plus.svg" alt="img" class="me-2">Add New Audit</a>
                    </div>
                </c:if>
            </div>
                        ...
                        <table class="table datanew">
                            ...
                            <c:forEach var="audit" items="${inventoryAudits}">
                                <tr>
                                    ...
                                    <td>
                                        <a class="me-3" href="InventoryAuditDetail?id=${audit.id}">
                                            <img src="assets/img/icons/eye.svg" alt="img">
                                        </a>
                                        <c:if
                                                test="${sessionScope.roleName == 'WAREHOUSE_STAFF' && audit.status == 'SUBMITTED'}">
                                            <a class="me-3"
                                        ...
                                        <c:if
                                                test="${sessionScope.roleName == 'MANAGER' && audit.status == 'DRAFT'}">
                                            <a class="me-3"
                                        ...
                                        <c:if
                                                test="${sessionScope.roleName == 'MANAGER' && audit.status == 'PENDING'}">
                                            <a class="me-3"
                                        ...
                                        <c:if
                                                test="${sessionScope.roleName == 'MANAGER' && (audit.status == 'DRAFT' || audit.status == 'SUBMITTED')}">
                                            <a class="me-3 cancel-audit" href="javascript:void(0);"
                                               data-id="${audit.id}" data-status="${audit.status}">
