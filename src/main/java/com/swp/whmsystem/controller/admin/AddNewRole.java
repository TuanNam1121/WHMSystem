 ...
 * @author LENOVO
 */
@WebServlet(name = "addNewRole", urlPatterns = {"/addNewRole"})
public class AddNewRole extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddNewRole</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddNewRole at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        Role r = new Role(0, name, isActive.equals("true"));
        rd.insertRole(r);
