...
<head>
    ...
    <title>Inventory Summary Report - WHM System</title>
...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="${pageContext.request.contextPath}/ImportExportByDayReport" method="get">
                        <!-- Filter Section -->
                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label>Search</label>
                                                    <input type="text" name="keyword" value="${keyword}" placeholder="Code or product name...">
                                                </div>
                                            </div>
                                            <div class="col-lg col-sm-6 col-12">
                                                <div class="form-group">
