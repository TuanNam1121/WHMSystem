...
<html lang="en">
    <head>
        ...
        <title>Edit Product - WHM System</title>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label>SKU</label>
                                            <input type="text" required name="sku" placeholder="VD: ST628W"
                                                   value="${p.sku}" ${transactionExist != null ? 'readonly' : ''}>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required name="productName"
                                                       placeholder="VD: ZenBook 14 UX3405CA" value="${p.name}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="select"
                                                        name="category" ${transactionExist != null ? 'disabled' : ''}>
                                                    <option>Choose Category</option>
                                                    <c:forEach var="i" items="${categoryList}">
                                                        <option value="${i.categoryId}" ${p != null && p.category.getCategoryId() == i.categoryId ? 'selected' : ''}>${i.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="select" name="brand"
                                                        id="brandSelect" ${transactionExist != null ? 'disabled' : ''}>
                                                    <option value="">Choose Brand</option>
                                                    <c:forEach var="i" items="${brandList}">
                                                        <option value="${i.id}"  ${p != null && p.brand.getId() == i.id ? 'selected' : ''}>${i.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="form-group">
                                                <label>Unit</label>
                                                <select class="select"
                                                        name="unit" ${transactionExist != null ? 'disabled' : ''}>
                                                    <c:forEach var="i" items="${unitList}">
                                                        <option value="${i.id}" ${p != null && p.unit.getId() == i.id ? 'selected' : ''}>${i.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="select" name="model"
                                                        id="modelSelect" ${transactionExist != null ? 'disabled' : ''}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select" name="ram" ${transactionExist != null ? 'disabled' : ''}>
                                                    ...
                                                    <c:forEach var="i" items="${ramList}">
                                                        <option value="${i.id}" ${p != null && p.ram.getId() == i.id ? 'selected' : ''}>${i.size}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select" name="rom" ${transactionExist != null ? 'disabled' : ''}>
                                                    ...
                                                    <c:forEach var="i" items="${romList}">
                                                        <option value="${i.id}" ${p != null && p.rom.getId() == i.id ? 'selected' : ''}>${i.size}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="form-group">
                                                <label>Chip</label>
                                                <select class="select"
                                                        name="chip" ${transactionExist != null ? 'disabled' : ''}>
                                                    <option>Choose Chip</option>
                                                    <c:forEach var="i" items="${chipList}">
                                                        <option value="${i.id}" ${p != null && p.chip.getId() == i.id ? 'selected' : ''}>${i.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="select" name="isActive">
                                                    <option value="1" ${p != null && p.isActive == true ? 'selected' : ''}>
                                                        Active
                                                    </option>
                                                    <option value="0" ${p != null && p.isActive == false ? 'selected' : ''}>
                                                        Deactive
                                                    </option>
                                                </select>
                                            </div>
